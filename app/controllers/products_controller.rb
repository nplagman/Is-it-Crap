...
# load_and_authorize_resource  :through => :current_user
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :brief, :price, :bullet1, :bullet2, :bullet3, :bullet4, :description, :buylink, :verdict, :category_id, :image, :youtube, :user_id, :goodverdict, :term)
    end
